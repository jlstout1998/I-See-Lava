...
public class ISeeLavaClientMod implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		FluidRenderHandlerRegistry.INSTANCE.register(Fluids.LAVA, Fluids.FLOWING_LAVA, new SimpleFluidRenderHandler(Identifier.fromNamespaceAndPath("minecraft", "block/lava_still"), Identifier.fromNamespaceAndPath("minecraft", "block/lava_flow")));
	}
}
